...
ENTRYPOINT ["java", "-Dorg.slf4j.simpleLogger.defaultLogLevel=debug", "-jar", "./ocisolacebridge-jar-with-dependencies.jar", "com.oracle.ocibridge.OCIBridge" ]